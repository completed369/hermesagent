...
/**
 * Recomputes the three authoritative Stage-6 opportunity scores from current
 * workspace-scoped state in one transaction. Client callers provide normalized
