...
function result(
  ...
  return {
    ...
    socketDirectoryIdentityReference: provisionGrant.socketDirectoryIdentityReference,
...
describe('bounded Linux retained-native path provisioner', () => {
  ...
  it.each([
    ...
    { socketDirectoryIdentityReference: 'linux:dev-5:ino-0' },
  ...
  it.each([
    ...
    { socketDirectoryIdentityReference: 'linux:dev-5:ino-7' },
