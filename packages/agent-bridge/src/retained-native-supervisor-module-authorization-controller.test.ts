...
function provisioned(
  ...
  return {
    ...
    parentDirectoryProvisioningId: `parent-directories-${kind.toLowerCase()}-1`,
    parentDirectoryProvisionRequestHash: kind === 'CLIENT' ? '8'.repeat(64) : '9'.repeat(64),
    parentDirectoryApprovalEvidenceHash: kind === 'CLIENT' ? '6'.repeat(64) : '7'.repeat(64),
