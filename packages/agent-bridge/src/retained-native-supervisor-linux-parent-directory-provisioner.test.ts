...
describe('bounded Linux retained-native parent-directory provisioner', () => {
  ...
  it.each([
    ...
    ['root provisioning drift', { runtimeRootProvisioningId: 'runtime-root-provision-two' }],
    ['root request drift', { runtimeRootProvisionRequestHash: 'f'.repeat(64) }],
    ['root approval drift', { runtimeRootApprovalEvidenceHash: 'f'.repeat(64) }],
