...
/**
 * Fail-closed helper for every implementation boundary. Callers must supply
 * the workspace explicitly; implementations must never infer or broaden it.
 */
...
/**
 * Memories are advisory context only. This helper makes the intended default
 * retrieval semantics explicit: exclude revoked, expired, and superseded rows.
 */
