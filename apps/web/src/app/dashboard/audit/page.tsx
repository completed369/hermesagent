  ...
  return (
    <div>
      ...
      <p style={{ color: 'var(--vos-text-muted)', fontSize: 13, marginTop: 0 }}>
        Append-only. Every sensitive action recorded here is tamper-evident (integrity-hashed) and
        can never be edited or deleted through the application.
      </p>
            ...
            <tbody>
              {data.map((e) => (
                <tr key={e.id} style={{ borderTop: '1px solid var(--vos-border)' }}>
                  ...
                  <td style={{ color: 'var(--vos-text-muted)' }}>
