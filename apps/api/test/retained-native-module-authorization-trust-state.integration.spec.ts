      ...
      authorizations: [
        {
          ...
          provisionedPaths: {
            ...
            approvalId: `level3-control-plane:audited-client-provisioning-${suffix}`,
            approvalEvidenceHash: 'e'.repeat(64),
            authorizedByReference: 'control-plane-owner-1',
            authorityLevel: 3,
            authorizedFrom: nowIso,
            authorizedUntil,
            parentDirectoryProvisioningId: `audited-parent-directory-provisioning-${suffix}`,
            parentDirectoryProvisionRequestHash: 'a'.repeat(64),
            parentDirectoryApprovalEvidenceHash: 'b'.repeat(64),
