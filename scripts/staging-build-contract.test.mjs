...
test('the immutable migration chain matches the reviewed sequence', () => {
  ...
  assert.deepEqual(migrations, [
    ...
    '20260905210000_guard_native_module_snapshot_publication',
    ...
    '20260908040000_revenue_run_correlation_spine',
    '20260908073000_revenue_run_outcome_link_delete_guard',
    '20260908093000_revenue_run_cost_reconciliation',
